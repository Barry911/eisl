...
(function(){
    angular.module("kittron", ['ui.router','homeModule','hotelModule','eventCenterModule','eventPlannerModule','vendorModule','ui.router.title','oc.lazyLoad','ngMaterial','satellizer','account' +
    '']);
})();
...
(function() {
    ...
    Kittron.config(['$locationProvider', '$urlRouterProvider', '$stateProvider','$ocLazyLoadProvider','$mdIconProvider','$authProvider', function ($locationProvider, $urlRouterProvider, $stateProvider,$ocLazyLoadProvider,$mdIconProvider,$authProvider) {
        ...
        $authProvider.baseUrl = 'http://kittron.com/api/public/';
...
angular.module('hotelModule')
    .controller('HotelResultCtrl',['$scope','orderByFilter',HotelResultCtrl]);

function HotelResultCtrl($scope,orderBy) {
...
angular.module('eventCenterModule')
    .controller('EventResultCtrl',['$scope','orderByFilter',EventResultCtrl]);

function EventResultCtrl($scope,orderBy) {
...
(function(){
    "use strict";
    angular.module("account", ['ui.router','angularCountryState','ngMessages','ngAnimate','satellizer']);
})();
/**
